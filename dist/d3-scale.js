// https://d3js.org/d3-scale/ v3.2.3 Copyright 2021 Mike Bostock
...
function calendar(year, month, week, day, hour, minute, second, millisecond, format, createDate = date) {
  var scale = continuous(),
      invert = scale.invert,
      domain = scale.domain;
...
function time(createDate = date) {
  return initRange.apply(calendar(d3Time.timeYear, d3Time.timeMonth, d3Time.timeWeek, d3Time.timeDay, d3Time.timeHour, d3Time.timeMinute, d3Time.timeSecond, d3Time.timeMillisecond, d3TimeFormat.timeFormat, createDate).domain([createDate(2000, 0, 1), createDate(2000, 0, 2)]), arguments);
}
